...
export default function EditUserForm(props){
    ...
    /*-----------------------------*/
    /* Se actualiza con los mismos datos, siempre cuando el usuario cambie */
    /*-----------------------------*/
    useEffect(() =>{
        setUserData({
            name: user.name,
    ...
    /*-----------------------------*/
    /* Se actualiza siempre, cuando el usuario cambie */
    /*-----------------------------*/
    useEffect(() =>{
        if(user.avatar){
...
/*-----------------------------*/
/* Maquetacion del Formulario  y donde obtengo los datos */
/*-----------------------------*/
